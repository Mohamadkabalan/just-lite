                    ...
                    <div class="footer-widget ps-5">
                        ...
                        <ul class="footer-contact">
                            <li>
                                ...
                                <span>
                                    <a href="https://api.whatsapp.com/send?phone=96170779100" target="_blank">
                                            {{ __('translation.phone-info') }}
                                    </a>
                                </span>
                            </li>
                            <li>
...
<!-- Footer Area End -->
<!-- END FOOTER -->
<a href="https://api.whatsapp.com/send?phone=96170779100" target="_blank" class="scroll-whatsapp">
